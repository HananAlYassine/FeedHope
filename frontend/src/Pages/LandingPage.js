...
const LandingPage = () => {
    ...
    // Auto-redirect: if the user opted into Remember Me at sign-in,
    // skip the landing page on subsequent app launches and drop them
    // straight onto their dashboard.
    useEffect(() => {
        const remember = localStorage.getItem("feedhope_remember") === "1";
        ...
        try {
            ...
            /* corrupt session — show the landing page normally */
        }
    }, [navigate]);
