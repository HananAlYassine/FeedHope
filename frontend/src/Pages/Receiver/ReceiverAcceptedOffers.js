...
// // const FeedbackModal = ({ isOpen, onClose, onSubmit, offerTitle }) => {
...
// //                     <button className="ram-btn-cancel-modal" onClick={onClose}>Cancel</button>
...
//     // ✅ FIX: Parse user once and store in state (lazy initializer)
//     const [user] = useState(() => {
...
//     // ✅ Now userId is stable (primitive, not object)
...
//             setLoading(false);
//         }
//     }, [userId]); // ✅ depends only on userId (primitive)
...
//         }
//         fetchAcceptedOffers();
//     }, [userId, navigate, fetchAcceptedOffers]); // ✅ stable
...
//                 <ReceiverSidebar onLogout={handleLogout} unreadCount={0} activePage="accepted" />
...
//  FeedHope — Omar & Hanan
//  Pages/Receiver/ReceiverAcceptedOffers.js
//  Rate Your Experience (Donor + Volunteer)
// ============================================================
...
// ============================================================
// RateExperienceModal – inside the same file, before the main component
// ============================================================
const RateExperienceModal = ({ isOpen, onClose, onSubmit, offerTitle, donorName, volunteerName }) => {
    const [donorRating, setDonorRating] = useState(5);
    const [volunteerRating, setVolunteerRating] = useState(5);
...
const ReceiverAcceptedOffers = () => {
    ...
    // Updated submitFeedback – accepts donorRating, volunteerRating, comment
    ...
    return (
        <div className="rdb-layout">
            ...
            {/* Use the new RateExperienceModal */}
            <RateExperienceModal
                isOpen={isModalOpen}
                onClose={() => setIsModalOpen(false)}
                onSubmit={submitFeedback}
